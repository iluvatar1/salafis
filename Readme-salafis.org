...
- Solicitud de cuenta :: Usted debe tener cuenta en la sala de física.
  ...
  también puede hacerlo de forma individual llenando el siguiente formulario: https://forms.gle/mZpHrTQ5i1eP2ef28 .
...
- Software y configuración básica ::  Las cuentas de usuario tienen un límite de
  ...
  compatibiliadThank you demás (solamente se unsa software libre) : https://forms.gle/GyaSL8d1rxFAry9U8
...
solución alternativa: usar una vpn.
