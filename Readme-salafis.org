...
memoria) para la persistencia (solamente funciona con Ubuntu), y CERCIÓRESE MUY
BIEN DE SELECCIONAR EL NOMBRE EXACTO DE LA UNIDAD DE USB DRIVE, porque de otra
manera puede arriesgarse a formatear su computador. El nombre que aparece en la
figura es típico de Mac Os X. En Windows debe ser de la form =D:= o similar.
#+ATTR_HTML: :width 80%
...
Despues de terminar, tendrá una usb , con persistencia, que puede usar
para que su computador inicie desde ella y así tener disponible un linux sin
instalarlo realmente y usando todo el hardware de su máquina.
