...
[[file:figs/salafis.png]] . *Los ips disponibles actualmente están en el rango
~192.168.10.[3-26]~.*
...
conectará a los clientes internos (ips en el rango ~192.168.10.[3-26]~) usando
...
- Instale el cliente descargándolo de client desde
  ...
  https://www.xquartz.org/* Enlaces directos:
...
- Ejecute x2go y en el menú seleccione =Session -> New Session=. Allí llene la
  ...
  ~19.168.10.[3-26]~, como, por ejemplo, ~192.168.10.4~), en login su nombre de
