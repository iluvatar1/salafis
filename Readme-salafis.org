...
edades. Actualmente ([2024-09-12 Thu]) se tiene la siguiente configuración:
...
2. Conectarse usando xpra (en proceso de implementacion)
3. Conectarse por el protocolo ssh al servidor principal y de allí navegar a los
...
** TODO Conexión gráfica usando xpra
